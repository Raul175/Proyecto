...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" id="contenido">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary">Complementos</h6>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-1 text-center align-middle">
                                                <i class="fas fa-trash fa-sm mr-2" data-toggle="modal" style="cursor: pointer" data-target="#eliminar<?= $complemento['IdComplemento'] ?>"></i>
                                                <i class="fas fa-edit fa-sm" data-toggle="modal" style="cursor: pointer" data-target="#actualizar<?= $complemento['IdComplemento'] ?>"></i>
                                                <div class="modal fade" id="eliminar<?= $complemento['IdComplemento'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">Seleccionar "Eliminar" si quieres eliminar el complemento actual.</div>
                                                        <div id="error-message2" class="alert alert-danger" style="display: none;"></div>
                                                            <div class="modal-footer">
                                                                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                                                                <form id="deleteForm">
                                                                    <input type="hidden" id="id" value="<?= $complemento['IdComplemento'] ?>"/>
                                                ...
                                                <div class="modal fade" id="actualizar<?= $complemento['IdComplemento'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form id="updateForm" action="index.php" method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="hidden" class="form-control" value="<?= $complemento['IdComplemento'] ?>" name="id1" id="id1">
                                                                <div class="form-group">
                                                                    <label for="nombre">Nombre</label>
                                                                    <input type="text" class="form-control" value="<?= $complemento['Nombre'] ?>" name="nombre" id="nombre">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <!-- Encabezado del modal -->
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Insertar Complemento</h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            const nombrePattern = /^[a-zA-Z0-9\s]{1,50}$/;
            if (!nombrePattern.test(nombre)) {
                $(this).find("#nombre-error1").show();
                $(this).find("#nombre1").addClass("is-invalid");
                error = 1;
            }else{
            ...
            if (error == 0) {
                $.ajax({
                    ...
                    success: function(response) {
                        if (response == true) {
                            window.location.href = "/Proyecto/admin/complementos";
                        } else {
