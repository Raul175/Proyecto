...
<body id="page-top">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-1 text-center align-middle">
                                                <i class="fas fa-trash fa-sm mr-2" data-toggle="modal" style="cursor: pointer" data-target="#eliminar<?= $codigo['IdCodigo'] ?>"></i>
                                                <i class="fas fa-edit fa-sm" data-toggle="modal" style="cursor: pointer" data-target="#actualizar<?= $codigo['IdCodigo'] ?>"></i>
                                                <div class="modal fade" id="eliminar<?= $codigo['IdCodigo'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">Seleccionar "Eliminar" si quieres eliminar el código actual.</div>
                                                        <div id="error-message2" class="alert alert-danger" style="display: none;"></div>
                                                            <div class="modal-footer">
                                                                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                                                                <form id="deleteForm">
                                                                    <input type="hidden" id="id" value="<?= $codigo['IdCodigo'] ?>"/>
                                                ...
                                                <div class="modal fade" id="actualizar<?= $codigo['IdCodigo'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            ...
                                                            <button class="close" type="button" data-dismiss="modal" aria-label="Close" onclick="$('#updateForm')[0].reset(); $('[id$=\'error1\']').hide();$('.is-invalid').removeClass('is-invalid');">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        </div>
                                                        <form id="updateForm" action="index.php" method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="hidden" class="form-control" value="<?= $codigo['IdCodigo'] ?>" name="id1" id="id1">
                                                                <div class="form-group">
                                                                    <label for="codigo">Código</label>
                                                                    <input type="text" class="form-control" value="<?= $codigo['Codigo'] ?>" name="codigo" id="codigo">
                                                                    <div class="invalid-feedback" style="display: none;" id="codigo-error">
                                                                        El codigo es inválido o demasiado largo.
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="descuento">Descuento</label>
                                                                    <input type="number" step="0.01" class="form-control" value="<?= $codigo['Descuento'] ?>" name="descuento" id="descuento">
                                                                    <div class="invalid-feedback" style="display: none;" id="descuento-error">
                                                                        El descuento está mal introducido (Ejemplo: XX.XX).
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button class="btn btn-secondary" type="button" onclick="$('#updateForm')[0].reset(); $('[id$=\'error1\']').hide();$('.is-invalid').removeClass('is-invalid');" data-dismiss="modal">Cancelar</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <!-- Encabezado del modal -->
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Insertar Código</h5>
            ...
            <form id="insertForm" action="index.php" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="descuento">Descuento</label>
                        <input type="number" step="0.01" class="form-control" name="descuento" id="descuento1">
                        <div class="invalid-feedback" style="display: none;" id="descuento-error1">
                            El descuento está mal introducido (Ejemplo: XX.XX).
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            const descuento = $(this).find("#descuento1").val();

            const codigoPattern = /^[a-zA-Z0-9\s]{1,50}$/;
            ...
            const descuentoPattern = /^(100(\.00?)?|[0-9]{1,2}(\.\d{1,2})?)$/;
            if (!descuentoPattern.test(descuento)) {
                $("#descuento-error1").show();
                $("#descuento1").addClass("is-invalid");
                error = 1;
            }else{
                $("#descuento-error1").hide();
            }
            ...
            if (error == 0) {
                $.ajax({
                    ...
                    success: function(response) {
                        if (response == true) {
                            window.location.href = "/Proyecto/admin/codigos";
                        } else {
            ...
            if (!codigoPattern.test(codigo)) {
                ...
                $(this).find("#codigo").addClass("is-invalid");
                error = 1;
            }else{
            ...
            const descuentoPattern = /^(100(\.00?)?|[0-9]{1,2}(\.\d{1,2})?)$/;
            if (!descuentoPattern.test(descuento)) {
                $("#descuento-error").show();
                $("#descuento").addClass("is-invalid");
                error = 1;
            }else{
                $("#descuento-error").hide();
            }
